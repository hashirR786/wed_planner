...
// A curated mini photo strip from real portfolio images
const footerGallery = [
  '/couple stories/couple 1.webp',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="space-y-2">
              ...
              />
              <span className="text-[10px] uppercase tracking-[0.25em] text-[#C87D65] block">
                Cinematic Photography Studio — {siteConfig.location}
              </span>
            </div>

            <p className="text-white/70 text-sm leading-relaxed max-w-md font-light">
              Documenting authentic love, raw emotion, and fine art milestone stories across London and the UK.
            </p>
            ...
            <div className="flex items-center space-x-4 pt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/80 hover:text-white hover:border-[#25D366] hover:bg-[#25D366]/10 transition-colors"
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-3 text-sm text-white/70 font-light">
              <li className="flex items-start gap-2">
                <span className="text-[#C87D65] shrink-0">Location:</span>
                <span>{siteConfig.location}</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-[#C87D65] shrink-0">Email:</span>
          ...
          {/* Instagram Mini Gallery Strip — 4 cols */}
          <div className="lg:col-span-4 space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="font-serif text-lg text-[#C87D65] tracking-wider uppercase">On Instagram</h4>
              <a
                href={siteConfig.instagram}
                target="_blank"
                rel="noopener noreferrer"
                className="text-[10px] uppercase tracking-widest text-white/50 hover:text-[#C87D65] transition-colors flex items-center gap-1"
              >
                Follow <ArrowUpRight size={11} />
              </a>
            </div>

            {/* 2×2 Photo Grid pulled from portfolio */}
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-white/50 space-y-4 sm:space-y-0">
          ...
          <div className="flex items-center space-x-6">
            ...
            <span>•</span>
            <span className="text-[#C87D65]">Cinematic Fine Art Storytelling</span>
          </div>
        </div>
